...
public class RegisterUser extends JFrame {
        ...
        public String getTextoNombres() {
                String var = textoNombres.getText();
                if (textoApellidos.getText() != "") {
                        var = textoNombres.getText() + " " + textoApellidos.getText();
        ...
        public Boolean getFilledTexts() {
                System.out.println(getTextoNombres());
                if (getTextoNombres() != null && getTextoUsuario() != null && getTextoDireccion() != null && getTextoCorreo() != null && getTextPassword() != null) {
                        return true;
                }
                return false;
        }
