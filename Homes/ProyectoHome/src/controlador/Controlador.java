...
public class Controlador implements MouseListener {
        ...
        public void registrarUsuario(RegisterUser user) {
                try {
                        if (usuarioExists(user.getTextoUsuario())) {
                                Usuario u = new Usuario();
                                if (user.getFilledTexts()) {
                                        System.out.println(user.getTextoNombres()+user.getTextoUsuario()+"vvv");
                                        u.setNombre(user.getTextoNombres());
                                        u.setUsuario(user.getTextoUsuario());
                                        u.setCorreo(user.getTextoCorreo());
                                        u.setPass(user.getTextPassword());
                                        u.setDireccion(user.getTextoDireccion());
